...
if(isset($_POST['type']) && $_POST['type']=="alumni" ){
    ...
    if(empty($DepartmentofGraduation)){
        $errors['DepartmentofGraduation'] = "DepartmentofGraduation  is required!";
    }
    ...
    //Encode the response as JSON and send it back to the AJAX script
...
if(isset($_POST['type']) && $_POST['type']=="job" ){
    ...
    if(empty($Company)){
        $errors['Company'] = "Company No is required!";
    }
    if(empty($JobTitle)){
        $errors['JobTitle'] = "Job Title No is required!";
    }
    ...
    if(empty($ReferralEmail)){
        $errors['ReferralEmail'] = "Referral Email  is required!";
    }
    ...
    if(empty($phonenumber)){
        $errors['phonenumber'] = "Last Date To Apply  is required!";
    }
...
if(isset($_POST['type']) && $_POST['type']=="apply" ){
    ...
    if ($UploadResume['error'] !== UPLOAD_ERR_OK) {
        $errors['UploadResume'] = "Upload Resume is required!";
    }
